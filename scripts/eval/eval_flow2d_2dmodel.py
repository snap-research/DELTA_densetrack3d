...
class DefaultConfig:
    ...
    checkpoint: str = (
        "checkpoints/densetrack3d.pth"  # Evaluate_result (avg) {'epe_all': 0.9571508765220642, 'epe_occ': 3.053309440612793, 'epe_vis': 0.5193737149238586, 'iou': 0.8188568353652954}
    )
...
class RayPredictor:
    ...
    def run_eval(self, split):
        ...
        test_dataset = CVO(data_root=cfg.dataset_root, split=split, debug=False)
